...
#: Specifies the AWS account ID of the expected bucket owner for S3 operations.
#: This is used to prevent bucket impersonation attacks by verifying bucket ownership.
#: (default: ``None``)
